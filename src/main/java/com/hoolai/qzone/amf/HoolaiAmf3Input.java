...
public class HoolaiAmf3Input extends HoolaiAbstractAmfInput implements Amf3Types
{
    /**
     * @exclude
     */
    ...
    public HoolaiAmf3Input(SerializationContext context)
    {
        super(context);
    ...
    protected Object readScriptObject() throws ClassNotFoundException, IOException
    {
        ...
        else
        {
            ...
            else if (context.instantiateTypes || className.startsWith("flex."))
            {
                ...
                //注释掉下面查找proxy来令proxy一直是null，避免解析AOS对象时抛出ClassNotFoundException
