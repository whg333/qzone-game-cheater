...
public class HoolaiAmf0Input extends HoolaiAbstractAmfInput implements AmfTypes
{
    /**
    ...
    public HoolaiAmf0Input(SerializationContext context)
    {
        super(context);
    ...
    protected Object readObjectValue(int type) throws ClassNotFoundException, IOException
    {
        ...
        switch (type)
        {
            ...
            case kAvmPlusObjectType:
                ...
                if (avmPlusInput == null)
                {
                    avmPlusInput = new HoolaiAmf3Input(context);
